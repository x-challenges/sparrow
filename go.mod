...
require github.com/x-challenges/raven v0.1.18
...
require (
	...
	github.com/ydb-platform/ydb-go-sdk/v3 v3.93.1 // indirect
	// github.com/ydb-platform/ydb-go-sdk/v3 v3.94.0 // indirect
